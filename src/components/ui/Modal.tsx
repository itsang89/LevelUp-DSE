  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      <div 
        ...
        onClick={onClose} 
      />
      <div className="relative w-full max-w-lg flex flex-col overflow-hidden rounded-3xl sm:rounded-[2.5rem] bg-surface shadow-2xl animate-in fade-in zoom-in slide-in-from-bottom-8 duration-500 hairline-border max-h-[90vh]">
        <button
          onClick={onClose}
